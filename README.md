...
As shown in the table above, we illustrate a case where a response is generated given a dialogue context. The dialogue context is about <font color=Crimson>speech competition</font>. This example proves that TIGER can: 
...
&#11088; A GPU with 24G memory (18GB at runtime) is enough for the demo.  
